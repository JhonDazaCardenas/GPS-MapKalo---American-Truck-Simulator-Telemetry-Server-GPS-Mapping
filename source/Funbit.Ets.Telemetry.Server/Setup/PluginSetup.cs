...
namespace Funbit.Ets.Telemetry.Server.Setup
{
    public class PluginSetup : ISetup
    {
        ...
        const string Ats = "American Truck Simulator";
        SetupStatus _status;
        ...
        class GameState
        {
            ...
            string GameDirectoryName => "American Truck Simulator";
            ...
            public void InstallPlugin()
            {
                ...
                File.Copy(LocalAtsX86TelemetryPluginDllFileName, x86DllFileName, true);

                Log.InfoFormat("Copying {1} x64 plugin DLL file to: {0}", x64DllFileName, _gameName);
                File.Copy(LocalAtsX64TelemetryPluginDllFileName, x64DllFileName, true);
            }
            ...
            static string LocalAtsX86TelemetryPluginDllFileName => Path.Combine(
                AppDomain.CurrentDomain.BaseDirectory, @"Ets2Plugins\win_x86\plugins\", TelemetryDllName);

            static string LocalAtsX64TelemetryPluginDllFileName => Path.Combine(
